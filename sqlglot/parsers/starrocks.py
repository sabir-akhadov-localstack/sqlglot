...
from sqlglot.parsers.mysql import Parser as _MySQLParser, _MYSQL_FUNCTIONS, _MYSQL_PROPERTY_PARSERS
...
def _property_rollup_parser(self: "Parser") -> exp.RollupProperty:
    return self._parse_rollup_property()
...
class Parser(_MySQLParser):
    ...
    PROPERTY_PARSERS = {
        **_MYSQL_PROPERTY_PARSERS,
        ...
        "ROLLUP": _property_rollup_parser,
