...
_ID_VAR_TOKENS.remove(TokenType.UNION)
...
class Parser:
    ...
    FUNCTION_PARSERS = _FUNCTION_PARSERS
    ...
    def __init_subclass__(cls, **kwargs: t.Any) -> None:
        ...
        cls.SHOW_TRIE = new_trie(key.split(" ") for key in getattr(cls, "SHOW_PARSERS", {}))
        cls.SET_TRIE = new_trie(key.split(" ") for key in getattr(cls, "SET_PARSERS", {}))
